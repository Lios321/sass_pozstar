...
export class NotificationService {
  ...
  static async createServiceOrderStatusNotification(
    ...
    try {
      ...
      const title = `OS #${serviceOrder.orderNumber} - Status Atualizado`
  ...
  static async createNewServiceOrderNotification(serviceOrderId: string) {
    try {
      ...
      const title = `Nova Ordem de Serviço #${serviceOrder.orderNumber}`
      const message = `Sua ordem de serviço foi criada e está sendo processada. Equipamento: ${serviceOrder.brand} ${serviceOrder.model}`
  ...
  static async createTechnicianAssignedNotification(
    ...
    try {
      ...
      const title = `Técnico Atribuído - OS #${serviceOrder.orderNumber}`
      const message = `O técnico ${serviceOrder.technician?.name} foi atribuído à sua ordem de serviço`
